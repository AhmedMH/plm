...
<div class='row' >
    ...
    <div class="col-md-5 center-block" style="float:none;">
    	<h2 class="sign-up-title" style="color:dimgray; text-align: center">Welcome! Create your account</h2>
        <hr style="height: 5px;
  border-top: 0;
  background: #669AE1;
  border-radius: 5px;">
  @if (count($errors) > 0)
		...
		<div class="row">
			<div class="col-xs-12">	
			    <form class="omb_loginForm" action="{{ url('/auth/register') }}" autocomplete="off" method="POST">
			    <input type="hidden" name="_token" value="{{ csrf_token() }}">
			    <div class="input-group">
						<span class="input-group-addon"><i class="fa fa-user"></i></span>
						<input type="text" class="form-control" style="height:40px;" name="name" value="{{ old('name') }}" placeholder="Full Name">
					</div>
					...
					<div class="input-group">
						...
						<input  type="password" class="form-control" name="password_confirmation" style="height:40px;" placeholder="Confirm Password">
					</div>
                    <span class="help-block"></span>
					<button class="btn btn-lg btn-success btn-block" type="submit">Register <i class="fa fa-sign-in"></i></button>
                    <span class="help-block"></span>
				</form>
			</div>
    	</div>
...
<div class="col-xs-12">
      <a class="btn btn-block btn-social btn-lg  btn-google-plus">
        ...
        <br>
        <p class="text-center"><a href="{{ url('/auth/login') }}">Already have an account?</a></p>
